    ...
    <div class="main">
        <form action="register1.php" method="post" autocomplete="off">
            <div id="name">
                ...
                <input class="firstname" type="text" name="fname" id="fname" ><br>
                <label class="firstlabel">First Name</label>
                <input class="lastname" type="text" name="lname" id="lname">
                <label class="lastlabel">last name</label>
            </div>
         <h2 class="name">Institute name</h2>
         <input class="company" type="text" name="station" id="station">
         <h2 class="name">Email</h2>
         <input class="email" type="text" name="email" id="email">
         <h2 class="name">Phone</h2>
         <input class="code" type="text" name="areacode">
         <label class="Area-code" >Area code</label>
         <input  class="number" type="text" name="phone" id="">
         ...
         <option  name="postp" value="Inspector">UG</option>
         <option  value="IPS">PG</option>
         <option value="DGP">PHD</option>
         </select>
